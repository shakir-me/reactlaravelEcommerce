...
function AddBrand(){
    ...
    const brandSubmit = (e) => {
        ...
        const data = {
            ...
            meta_description: brandInput.meta_description,
                ...
                <div class="tab-pane card-body border  fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                    ...
                    <div className="form-group mb-3">
                     ...
                     <div className="form-group mb-3">
                        ...
                        <textarea  name="description"  onChange={handleInput} value={brandInput.description} className="form-control" ></textarea>
                     </div>

                     <div className="form-group mb-3">
                        <label>Status :</label>
                        <input type="checkbox" name="status"  onChange={handleInput} value={brandInput.status} />    Status 0=shown/1 =hidden
                     </div>
                  ...
                  <div class="tab-pane card-body border  fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                   ...
                   <div className="form-group mb-3">
                        ...
                        <input type="text" name="meta_title" onChange={handleInput} value={brandInput.meta_title}  className="form-control" />   
                     </div>
                     <div className="form-group mb-3">
                        <label>Meta Keyword </label>
                        <textarea  name="meta_keyword"  onChange={handleInput} value={brandInput.meta_keyword}  className="form-control" ></textarea>
                     </div>

                     <div className="form-group mb-3">
                        <label>Meta Description </label>
                        <textarea  name="meta_description"  onChange={handleInput} value={brandInput.meta_description} className="form-control" ></textarea>
                     </div>
                </div>
